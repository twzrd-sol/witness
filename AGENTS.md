...
Agents pay for an independent fact + signed receipt. Not intel. Not mpp. Not outbid.

Retrieval is **existing** `https://reader.outbid.sh` scrape ($0.005) / browse ($0.05).
Do not reimplement Chromium. Do not call intel `/v1/witness/attest` (device keys).
