...
const tasks = [
  ...
  // Split from one 2 USDC task (operator, 2026-09-10): no observable wallet clears a 2 USDC cap.
  { description: 'Write the quote-then-witness client guide, part 1: refused quotes and the 402 challenge path.', reward_minor: 1000000, source: 'README.md; src/server.js' },
  { description: 'Write the quote-then-witness client guide, part 2: failed retrieval and offline receipt verification.', reward_minor: 1000000, source: 'src/retrieve.js; src/receipt.js; docs/operator-trial.md' },
];
